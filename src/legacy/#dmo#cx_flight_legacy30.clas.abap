CLASS /dmo/cx_flight_legacy30 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_30',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_30',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id30 OPTIONAL
        booking_id            TYPE /dmo/booking_id30 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id30 OPTIONAL
        agency_id             TYPE /dmo/agency_id30 OPTIONAL
        customer_id           TYPE /dmo/customer_id30 OPTIONAL
        carrier_id            TYPE /dmo/carrier30-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_30-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_30-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date30 OPTIONAL
        end_date              TYPE /dmo/end_date30 OPTIONAL
        booking_date          TYPE /dmo/booking_date30 OPTIONAL
        flight_date           TYPE /dmo/flight_date30 OPTIONAL
        status                TYPE /dmo/travel_status30 OPTIONAL
        currency_code         TYPE /dmo/currency_code30 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id30,
          mv_booking_id            TYPE /dmo/booking_id30,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id30,
          mv_agency_id             TYPE /dmo/agency_id30,
          mv_customer_id           TYPE /dmo/customer_id30,
          mv_carrier_id            TYPE /dmo/carrier30-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_30-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_30-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date30,
          mv_end_date              TYPE /dmo/end_date30,
          mv_booking_date          TYPE /dmo/booking_date30,
          mv_flight_date           TYPE /dmo/flight_date30,
          mv_status                TYPE /dmo/travel_status30,
          mv_currency_code         TYPE /dmo/currency_code30,
...
CLASS /dmo/cx_flight_legacy30 IMPLEMENTATION.
