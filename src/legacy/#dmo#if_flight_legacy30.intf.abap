...
INTERFACE /dmo/if_flight_legacy30
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL30
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel30     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING30
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking30    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_30
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_30 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT30
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight30 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id30.
  ...
  TYPES booking_id TYPE /dmo/booking_id30.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id30.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL30, /DMO/BOOKING30, /DMO/BOOK_SUP_30 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code30.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code30,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status30,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel30_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id30.
  INCLUDE TYPE /dmo/booking30_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id30.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id30.
  INCLUDE TYPE /dmo/book_sup_30_data.
